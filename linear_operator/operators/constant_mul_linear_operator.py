...
class ConstantMulLazyTensor(LazyTensor):
    ...
    .. note::
        ...
        To element-wise multiply two lazy tensors, see :class:`MulLazyTensor`
    ...
    Example::
        ...
        >>> base_base_lazy_tensor = ToeplitzLazyTensor([1, 2, 3])
        >>> constant = torch.tensor(1.2)
        >>> new_base_lazy_tensor = ConstantMulLazyTensor(base_base_lazy_tensor, constant)
        ...
        >>> #  [ 3.6, 2.4, 1.2 ]]
        >>>
        >>> base_base_lazy_tensor = ToeplitzLazyTensor([[1, 2, 3], [2, 3, 4]])
