...
class CachedCGLazyTensor(LazyTensor):
    ...
    Args:
        :attr:`base_lazy_tensor` (:class:`LazyTensor`):
            the LazyTensor to wrap
        :attr:`eager_rhss` (list of :class:`LazyTensor`):
            list of right-hand sides with eagerly-computed solves
        :attr:`solves` (list of :class:`LazyTensor`):
            list of solves associated with :attr:`eager_rhss`
        :attr:`probe_vectors` (:class:`LazyTensor`, optional):
            normalized probe vectors (for computing logdet with SLQ)
        :attr:`probe_vector_norms` (:class:`LazyTensor`, optional):
        ...
        :attr:`probe_vector_solves` (:class:`LazyTensor`, optional):
            solves associated with :attr:`probe_vectors` (for computing logdet with SLQ)
        :attr:`probe_vector_tmats` (:class:`LazyTensor`, optional):
